import{r as s}from"./index-76fb7be0.js";import{P as w,m as x,c as y}from"./api.esm-2e2d159c.js";import{C as k,u as j}from"./componentbase.esm-b0caea1e.js";import"./_commonjsHelpers-de833af9.js";import"./hooks.esm-c93f10ee.js";function i(t){"@babel/helpers - typeof";return i=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},i(t)}function _(t,e){if(i(t)!=="object"||t===null)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var n=o.call(t,e||"default");if(i(n)!=="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}function R(t){var e=_(t,"string");return i(e)==="symbol"?e:String(e)}function E(t,e,o){return e=R(e),e in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}var D={root:function(e){var o=e.props;return y("p-skeleton p-component",{"p-skeleton-circle":o.shape==="circle","p-skeleton-none":o.animation==="none"})}},z=`
@layer primereact {
    .p-skeleton {
        position: relative;
        overflow: hidden;
...
//# sourceMappingURL=Skeleton.stories-f0da0241.js.map
